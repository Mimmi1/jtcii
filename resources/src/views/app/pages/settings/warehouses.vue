          ...
          <b-row>
            ...
            <b-col md="6">
              ...
              >
                <b-form-group :label="$t('Name') + ' ' + '*'">
                  <b-form-input
                    :placeholder="$t('Enter_Name_Store')"
            ...
            <b-col md="6">
                <b-form-group :label="$t('Phone')">
                  <b-form-input
                    :placeholder="$t('Enter_Phone_Store')"
                    label="Phone"
            ...
            <b-col md="6">
                <b-form-group :label="$t('Country')">
                  <b-form-input
                    :placeholder="$t('Enter_Country_Store')"
                    label="Country"
            ...
            <b-col md="6">
                <b-form-group :label="$t('City')">
                  <b-form-input
                    :placeholder="$t('Enter_City_Store')"
                    label="City"
            ...
            <b-col md="6">
              <b-form-group :label="$t('ZipCode')">
                <b-form-input
                  :placeholder="$t('Enter_ZipCode_Store')"
                  label="ZipCode"
